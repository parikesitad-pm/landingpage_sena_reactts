...
export const confirmedMilestones: Milestone[] = [
  ...
  },
  {
    ...
    description: "When a fever required a little stay in the hospital, Luca was braver than anyone could imagine.",
    icon: "health",
    confirmed: true,
  },
  {
  ...
  },
  {
    ...
    description: "One year of little discoveries, growing curiosity, and countless memories.",
  ...
  },
  {
    ...
    description: "Healthy, curious, and continuing to explore the world with Popo and Momo.",
    icon: "family",
    confirmed: true,
  },
];
