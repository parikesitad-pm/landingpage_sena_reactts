    ...
    <MainLayout>
      <div className="py-16 sm:py-24 bg-[var(--background)] transition-colors">
        <Container size="lg">
          ...
          <div className="bg-[var(--surface)] rounded-3xl p-8 sm:p-14 border border-[var(--border)] shadow-sm mb-14 text-center">
        ...
        {/* Return Home CTA */}
        <Container size="lg">
          <div className="text-center pt-10 border-t border-[var(--border)] mt-12">
            <Link to={homePath}>
